...
class QuizInterface:
    ...
    def  __init__(self, quiz_brain: QuizBrain):
       ...
       true_image = PhotoImage(file=r"D:\Python Course\quizzler-app-start\images\true.png")
       self.true_button =Button(image=true_image, highlightthickness=0, command=self.true_pressed)
       self.true_button.grid(row=2, column=0)

       false_image = PhotoImage(file=r"D:\Python Course\quizzler-app-start\images\false.png")
